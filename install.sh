...
wget -4 https://github.com/HamedAp/ioncube-loader/releases/download/1.0/ioncube_loaders_lin_x86-64.tar.gz
...
if [ $(uname -m) = "aarch64" ]; then
    arch="arm64"
    wget -4 https://github.com/HamedAp/ioncube-loader/releases/download/1.0/ioncube_loaders_lin_aarch64.tar.gz
